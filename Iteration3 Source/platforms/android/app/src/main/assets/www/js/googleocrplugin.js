...
angular.module('googleocr', ['ionic','ngCordova']).controller('googleocrcontrol', function($scope,$http,$ionicActionSheet, $ionicLoading, $ionicPlatform, $cordovaCamera) {
  ...
  $scope.GetText = function(){
    ...
    $http({
      ...
      document.getElementById("Extracted_Text").innerHTML = data.responses[0].fullTextAnnotation.text;
      //document.getElementById("src_lang").innerHTML = data.responses[0].fullTextAnnotation.text;
      document.getElementById("translate").style.removeProperty("display");
